...
public class FoodList extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Cursor cursor = home.sqLiteHelper.getData("SELECT * FROM FOOD");
        list.clear();
...
// work
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                dialog.setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        if (item == 0) {
                            // update
                            Cursor c = home.sqLiteHelper.getData("SELECT id FROM FOOD");
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent showDetailActivity = new Intent(getApplicationContext(),BuyingActivity.class);
                showDetailActivity.putExtra("com.example.database.ITEM_INDEX",position);
    ...
    private void showDialogUpdate(Activity activity, final int position){
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    home.sqLiteHelper.updateData(
                            edtName.getText().toString().trim(),
                            edtPrice.getText().toString().trim(),
                            home.imageViewToByte(imageViewFood),
                            position
                    );
                    dialog.dismiss();
    ...
    private void showDialogDelete(final int idFood){
        ...
        dialogDelete.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                try {
                    home.sqLiteHelper.deleteData(idFood);
